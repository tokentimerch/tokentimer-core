...
// Worker used by the store-lock concurrency driver: one process, tries to
// acquire the store lock, holds it briefly while doing a real enrollment,
// releases.
// Usage: node windows-cng-concurrency-worker.js <stateDir> <workDir> <label> <commonName>
