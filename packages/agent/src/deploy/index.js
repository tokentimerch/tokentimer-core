...
// rollback) is Wave 2b, wired through the windows-cert-store-v1 and
// iis-binding-v1 capabilities (see ../capabilities); landing the target type
// and its typed shape now, without a matching executor, keeps this a
