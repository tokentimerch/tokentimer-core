...
// A quick structural snapshot of the test suite's shape, so a
// restack/rebase that silently drops a test file (or an entire describe
// block, or every it() inside one) shows up as a number that moved, not as
// silence.
//
