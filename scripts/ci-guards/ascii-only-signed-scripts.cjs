...
// Guard: ensures every file matching packages/agent/reference/*.ps1 is
// signable without Authenticode hash-mismatch risk. Microsoft documents
// signed PowerShell scripts containing non-ASCII UTF-8 content failing
// Authenticode hash validation across locales when the signing host's
// code page differs from the verifying host's
