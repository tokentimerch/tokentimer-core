...
// Discovery/runner for the M5c CI-guard backlog (tokentimer-canvas
// plan, "Quality and CI backlog" item #1): globs every other *.cjs
// file in this directory, runs each with `node`, and reports all
