...
- Certificates due for renewal but waiting on their issuing CA's per-CA capacity limit now show a distinct "At CA capacity" badge and a separate, non-alarming notice in the Upcoming renewals panel, instead of looking indistinguishable from a healthy auto-renewing certificate. No operator action is needed; the scheduler picks these up automatically once capacity frees up.
