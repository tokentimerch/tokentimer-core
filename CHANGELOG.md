...
Live end-to-end testing of the CertOps agent path found several defects that shared one shape: work that succeeded, was never connected to the system meant to manage it, and reported nothing wrong.
