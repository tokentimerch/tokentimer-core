...
- **Persistent operational failure notifications (#72).** Adds email-escalating, persistent notifications for operational failures, plus incidental fixes: JKS keystore detection by magic header regardless of field name, audit deep-link workspace scoping, and mark-read access control alignment with the read/read-all routes.
