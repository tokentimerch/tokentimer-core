...
describe("renewalAlertPolicy.classifyTerminalTransition", () => {
  ...
  const cases = [
    ...
    [
      "forced retirement with unknown side effects",
      "renew",
      "orphaned_unknown_effect",
      TRANSITION_ORIGINS.FORCED_RETIREMENT,
      true,
    ],
    ["executor failure", "renew", "failed", TRANSITION_ORIGINS.EXECUTOR_EVENT, true],
    ["executor rejection", "renew", "rejected", TRANSITION_ORIGINS.EXECUTOR_EVENT, true],
    ["executor success", "renew", "succeeded", TRANSITION_ORIGINS.EXECUTOR_EVENT, false],
